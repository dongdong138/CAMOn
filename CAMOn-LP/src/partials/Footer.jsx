        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-1 gap-8">
              <Link to="/" className="inline-block image-container" aria-label="Cruip">
                <img className="blurred-image logo-ctn1" src={HelloWorld}></img>
              </Link>
            </div>

            {/* 2nd, 3rd and 4th blocks */}
            <div className="md:col-span-4 lg:col-span-5 text-right">
              <div className="text-sm mb-5 blur-image">
